...
def augment_malayalam_data(input_file, output_file):
    ...
    for item in data:
        ...
        corrected_content = correct_spelling_ml(original_content)

        # 2. Sentence Splitting (if needed)
        sentences = sent_tokenize(corrected_content)
...
# Example usage:
input_file = r"C:\Users\Administrator\Documents\GitHub\Text cleaning\data\output_data\root1\http___www.puzha.com_blog_category_puzha-magazine_story__cleaned.json" #your input json file
output_file = r"C:\Users\Administrator\Documents\GitHub\Text cleaning\data\output_data\root2\augmented_malayalam_data.json" #output json file
